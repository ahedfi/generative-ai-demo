...
This version demonstrates **function calling** within the AI's responses, allowing it to invoke local functions such as fetching the current time and weather.

![AI Chat Console](docs/images/function-calling-demo.png)
...
- **Function Calling**: The AI can invoke local functions for tasks like retrieving the current time and weather information.
