...
This version demonstrates how to handle **structured output** in the AI's responses. For example, the AI is instructed to provide data in a structured format (e.g., returning movie information).

![AI Chat Console](docs/images/structured-output-demo.png)

---

## 🚀 Features
- Streamed AI responses for real-time interaction
- **Structured Output**: AI responses are parsed as structured data, such as returning a list of movies with specific properties.
