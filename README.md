...
This version demonstrates how to configure the **Temperature** parameter to control the creativity and variability of the AI's responses.

![AI Chat Console](docs/images/temperature-demo.png)

---

## 🚀 Features
- Streamed AI responses for real-time interaction
- Demonstrates adjusting the **Temperature** setting:
  - Higher values (e.g., `Temperature = 2`) lead to more creative and random responses.
  - Lower values (e.g., `Temperature = 0`) produce more focused and deterministic responses.
